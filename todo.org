- [nbe/simple.ts] definitional_equality_t.reflexivity
- [nbe/simple.ts] definitional_equality_t.beta_equality
- [nbe/simple.ts] definitional_equality_t.eta_equality
- [nbe/simple.ts] definitional_equality_t.compatibility
- [nbe/simple.ts] term_t.eval
- normalization by evaluation
  http://davidchristiansen.dk/tutorials/nbe/
- finish the little typer
- pie/core.ts
- minitt/core.ts
- nbe/dependent.ts
...
- term change: use pause and resume instead of ref and deref
- dot.ts -- new type of game, like deep ref_t for record_t
- step_t for `type-of-type.ts`
- `module.use ()`
- third argument of `new union_t ()`
- fix `.choices ()`
